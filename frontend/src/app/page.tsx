    ...
    <div className="min-h-screen bg-[#f9f8f7] text-[#111]">
      ...
      <section className="bg-white border-t border-b border-black/5 px-6 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {AMOSTRAS.map((a) => (
              <div key={a.criador} className="rounded-[20px] overflow-hidden border border-black/8 shadow-sm">
      ...
      <section className="px-6 py-14 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          {[
            ...
            <div key={t.titulo} className="bg-white border border-black/8 rounded-2xl p-6 shadow-sm">
      ...
      <footer className="border-t border-black/5 px-6 py-8 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link href="/sou-criador" className="text-xs text-gray-400 hover:text-[#DD2A7B] transition-colors font-medium">
